...
import 'package:home_service_app/features/profile/ui/widget/image_and_name_edit_card.dart';
                ...
                child: Column(
                  children: [
                    Card_profilescreen(
                      ...
                      subtitle: Text('For daily update and others '.tr(),
                    ...
                    InkWell(
                      onTap: () =>
                          context.pushNamed(Routes.selectAddressScreen),
                      child: Card_profilescreen(
